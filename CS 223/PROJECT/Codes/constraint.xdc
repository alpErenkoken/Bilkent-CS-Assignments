...
set_property PACKAGE_PIN T18 [get_ports BTND]
set_property IOSTANDARD LVCMOS33 [get_ports BTND]

set_property PACKAGE_PIN U17 [get_ports BTNU]
...
#set_property PACKAGE_PIN R2 [get_ports brush_large]
#set_property IOSTANDARD LVCMOS33 [get_ports brush_large]
